               ...
               Container(
                 ...
                 decoration: BoxDecoration(
                     image: DecorationImage(
                         fit: BoxFit.fill,
                         image: NetworkImage(ImagePath.url2)
                     )
                 ),
               ),
               Container(
                 ...
                 decoration: const BoxDecoration(
                     image: DecorationImage(
                         fit: BoxFit.fill,
                         image: NetworkImage(ImagePath.url)
                     )
                 ),
               ),
               Container(
                 ...
                 decoration: const BoxDecoration(
                     image: DecorationImage(
                         fit: BoxFit.fill,
                         image: NetworkImage(ImagePath.url3)
                     )
                 ),
               )
     ...
     return Column(
       ...
       children: [
                   ...
                   children: [
                     WidgetSpan(
                       child: Padding(
                         ...
                         child: Icon(Icons.location_on_sharp,color: Colors.grey,size: 16,),
                       ),
                     ),
                     TextSpan(text: 'Volagonj, Sylhet',style: TextStyle(color: Colors.grey,fontSize: 12),),
                   ],
                 ),
               ),
               Row(
         ...
         Padding(
           ...
           child: Text("Volagonj Sada Pathor",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,),),
         ),
         Container(
                   ...
                   children: [
                     WidgetSpan(
                       child: Padding(
                         ...
                         child: Icon(Icons.favorite_outlined,color: Colors.grey,size: 18,),
                       ),
                     ),
                     TextSpan(text: '125 ',style: TextStyle(color: Colors.grey,fontSize: 14,fontWeight: FontWeight.w900),),
                     TextSpan(text: ' People like this',style: TextStyle(color: Colors.grey,fontSize: 13),),
                 ...
                 text: const TextSpan(
                   children: [
                     WidgetSpan(
                       child: Padding(
                         padding: EdgeInsets.symmetric(horizontal: 2.0),
                         child: Icon(Icons.messenger_outline_outlined,color: Colors.grey,size: 18,),
                       ),
                     ),
                     TextSpan(text: ' 63 ',style: TextStyle(color: Colors.grey,fontSize: 14,fontWeight: FontWeight.w800),),
...
//------place description widget(Text)
   Widget fullDescWidget(){
     return const Padding(padding: EdgeInsets.all(10),
       child: Text(AppStrings.lorem,style: TextStyle(color: Colors.grey,fontWeight: FontWeight.w300),),);
   }
   ...
   Widget imageVideoDescWidget(){
     return Column(
       children: [
         InkWell(
           onTap: (){
             Get.toNamed(AppRoutes.photoView,arguments: [{"image": ImagePath.url3}]);
           },
           child: Container(
             height: 180,
   ...
   Widget toDoWidget(){
     return Column(
       ...
       children: [
         ...
         Padding(
           padding: const EdgeInsets.only(left: 10.0),
           child: Text("To Do",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,),),
         ),
         Container(
           margin: const EdgeInsets.only(left: 10.0,top: 8),
           height: 2,
     ...
     return Container(
       ...
       child: Column(
         ...
         children: [
           ...
           Padding(
             padding: const EdgeInsets.only(left: 10.0),
             child: Text(title,maxLines:2,style: TextStyle(color: Colors.white,fontWeight: FontWeight.w400),),
           )
         ],
       ),
     );
   ...
   Widget youMightLikeWidget(){
     return Column(
       ...
       children: [
         Padding(
           padding: const EdgeInsets.only(left: 10.0),
           child: Text("You might also like",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,),),
         ),
         Container(
           margin: const EdgeInsets.only(left: 10.0,top: 8),
           height: 2,
